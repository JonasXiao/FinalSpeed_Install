...
install_path=/fs/
package_download_url=https://github.com/JonasXiao/FinalSpeed_Install/blob/master/server/finalspeed_server_v1.2.zip
package_save_name=finalspeed_server_v1.2.zip
